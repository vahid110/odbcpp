...
**Implementation**: 37 exported ANSI ODBC entry points
...
- [ ] Primary/foreign keys (SQLPrimaryKeys complete; SQLForeignKeys pending)
...
- **Metadata APIs**: 3/8 functions (38% - table, column, and primary-key discovery)
