...
constexpr const char* SQLSTATE_PREPARED_STATEMENT_NOT_CURSOR = "07005";
...
constexpr const char* SQLSTATE_DATETIME_FIELD_OVERFLOW = "22008";
constexpr const char* SQLSTATE_RESTRICTED_DATA_TYPE = "07006";
constexpr const char* SQLSTATE_INVALID_CHARACTER_VALUE = "22018";
constexpr const char* SQLSTATE_STRING_DATA_RIGHT_TRUNCATION = "22001";
constexpr const char* SQLSTATE_STRING_DATA_TRUNCATED = "01004";
constexpr const char* SQLSTATE_INVALID_CONNECTION_STRING_ATTRIBUTE = "01S00";
...
constexpr const char* SQLSTATE_TRANSACTION_STATE_UNKNOWN = "25S01";
...
constexpr const char* SQLSTATE_ACCURACY_OPTION_OUT_OF_RANGE = "HY101";
constexpr const char* SQLSTATE_FUNCTION_TYPE_OUT_OF_RANGE = "HY095";
