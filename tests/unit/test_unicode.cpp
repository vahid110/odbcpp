...
TEST_F(UnicodeApiTest, WideCatalogApisValidateLengthsAndEncoding) {
  ...
  ASSERT_EQ(SQL_ERROR,
            SQLPrimaryKeysW(statement_, nullptr, 0, nullptr, 0,
                            invalid.data(), 1));
  ASSERT_EQ(SQL_SUCCESS,
            SQLGetDiagRecW(SQL_HANDLE_STMT, statement_, 1, state, nullptr,
                           nullptr, 0, nullptr));
  ...
  ASSERT_EQ(SQL_ERROR,
            SQLForeignKeysW(statement_, nullptr, 0, nullptr, 0,
                            invalid.data(), 1, nullptr, 0, nullptr, 0,
                            nullptr, 0));
  ASSERT_EQ(SQL_SUCCESS,
            SQLGetDiagRecW(SQL_HANDLE_STMT, statement_, 1, state, nullptr,
                           nullptr, 0, nullptr));
  ...
  ASSERT_EQ(SQL_ERROR,
            SQLStatisticsW(statement_, nullptr, 0, nullptr, 0,
                           invalid.data(), 1, SQL_INDEX_ALL, SQL_QUICK));
  ASSERT_EQ(SQL_SUCCESS,
            SQLGetDiagRecW(SQL_HANDLE_STMT, statement_, 1, state, nullptr,
                           nullptr, 0, nullptr));
  EXPECT_EQ("22018", as_utf8(state, 5));
  ...
  ASSERT_EQ(SQL_ERROR,
            SQLProceduresW(statement_, nullptr, 0, nullptr, 0,
                           invalid.data(), 1));
  ASSERT_EQ(SQL_SUCCESS,
            SQLGetDiagRecW(SQL_HANDLE_STMT, statement_, 1, state, nullptr,
                           nullptr, 0, nullptr));
  ...
  ASSERT_EQ(SQL_ERROR,
            SQLProcedureColumnsW(statement_, nullptr, 0, nullptr, 0,
                                 invalid.data(), 1, nullptr, 0));
  ASSERT_EQ(SQL_SUCCESS,
            SQLGetDiagRecW(SQL_HANDLE_STMT, statement_, 1, state, nullptr,
                           nullptr, 0, nullptr));
  EXPECT_EQ("22018", as_utf8(state, 5));
